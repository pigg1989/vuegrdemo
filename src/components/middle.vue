  ...
  methods: {
    ...
    handleApiLineNumber() {
      api
        ...
        .then(res => {
          ...
          this.onlineArr[2].number = this.numArr[0].number =
            res.data.statistics.totalPages;
          this.numArr[1].number =
            ...
            .then(res => {
              ...
              api
                ...
                .then(res => {
                  ...
                  this.onlineArr[0].offline =
                    this.onlineArr[0].number - this.onlineArr[0].online;
                });
            });
        });
    },
    ...
    handleApiProtocol() {
      api
        ...
        .then(res => {
          // console.log("协议1", res);
          this.protocolArr.push({
            name: "LoRa",
            value: res.data.statistics.totalPages
          });
          api
            .get("/inventory/managedObjects", {
              pageSize: 1,
            ...
            .then(res => {
              ...
              api
                ...
                .then(res => {
                  ...
                  this.protocol = Object.assign(this.protocol, {
                    series: [
                      {
                        data: [
                          {
                            value: this.protocolArr[0].value,
                            name: this.protocolArr[0].name
                          },
                          {
                            value: this.protocolArr[1].value,
                            name: this.protocolArr[1].name
                          },
                          {
                            value: this.protocolArr[2].value,
                            name: this.protocolArr[2].name
                          }
                        ]
                      }
                    ]
    ...
    handleApiBusiness() {
      api
        .get("/inventory2/managedObjects/aggaragate/count", {
          groupBy: `CIS.MFG_CD`,
