            ...
            .then(res => {
              ...
              api
                ...
                .then(res => {
                  ...
                  this.loraRing = Object.assign(this.loraRing, {
                    series: [
                      {
                        data: [
                          { value: this.onState, name: "开阀" },
                          { value: this.offState, name: "关阀" },
                          {
                            value: this.total - this.onState - this.offState,
                            name: "其它"
                          }
                        ]
                      }
